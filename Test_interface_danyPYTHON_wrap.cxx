...
/*-----------------------------------------------
              @(target):= _Exampletest_dany.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__Exampletest_dany

#else
#  define SWIG_init    init_Exampletest_dany

#endif
#define SWIG_name    "_Exampletest_dany"
...
SWIGINTERN PyObject *_wrap_mul(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:mul",&obj0,&obj1)) SWIG_fail;
  ecode1 = SWIG_AsVal_int(obj0, &val1);
  if (!SWIG_IsOK(ecode1)) {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"mul", _wrap_mul, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
